...
## 📚 Learning Note
⚠️ This project is built purely for learning purposes to understand microservices, distributed systems, and backend architecture. It is not intended for production use.
